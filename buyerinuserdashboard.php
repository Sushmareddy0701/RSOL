    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="outer-w3-agile mt-3">
                <h4 class="tittle-w3-agileits mb-4">Buyers in your Locality</h4>
                <div id="Hybridgraph" class="simple-chart1"><form action="location.php" method="post">
				<br>
				Enter Location:<input type="text" name="location2"></input><br><br>
				Enter Address:<input type="text" name="address"></input><br><br>
				Enter Time Of Pickup:<input type="time" name="time"></input><br><br>
